...
def detect_silence(audio_file, threshold=-50, min_silence_duration=20):
    ...
    for tmIndex in  range(len(voiceList)):
        if(tmIndex % 2) != 0:
            continue
        exportName = "E:\Temp_Files\Japanese\Combi_Chinese_Japanese\Generated" + os.sep + "JP_EXP_" + str(index) + ".mp3"
...
# 音频文件路径
audio_file = "E:\Temp_Files\Japanese\Combi_Chinese_Japanese\jpTest.mp3"
